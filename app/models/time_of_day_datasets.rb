...
module TimeOfDayDatasets
  ...
  included do
    ...
    def self.distance_time_of_day_and_average_speed
      ...
      map_time_of_day_average_speed(data)
    end
    ...
    def self.distance_time_of_day_and_time_spent_resting
      ...
      map_time_of_day_time_spent_resting(data)
    end
    ...
    def self.map_time_of_day_average_speed(data)
      data.map do |workout|
        [workout.distance_in_miles,
         [2016, 1, 1,
          workout.starting_datetime_in_local_time.hour,
    ...
    def self.map_time_of_day_time_spent_resting(data)
      data.map do |workout|
        [workout.distance_in_miles,
         [2016, 1, 1,
          workout.starting_datetime_in_local_time.hour,
